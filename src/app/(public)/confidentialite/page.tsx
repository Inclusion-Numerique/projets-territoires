    ...
    <div className="fr-container landing-main-container fr-my-8w">
      <div className="fr-grid-row fr-grid-row--center">
        <div className="fr-col-md-8">
          ...
          <p>
            La finalité du traitement de données réalisé par Aides-territoires
            est de faciliter la connaissance et l&apos;accès aux aides
            financières et en ingénierie pour permettre aux collectivités et
            acteurs du territoire de réaliser leurs projets.
          </p>
            ...
            <table className="data-table" data-fr-js-table-element="true">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    demande adressée à l’équipe La France des solutions, en vue
